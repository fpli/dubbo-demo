...
public class JwtRealm extends AuthorizingRealm {
	...
	protected AuthorizationInfo doGetAuthorizationInfo(PrincipalCollection principals) {
		/*********************************************
		 * RestfulPermissionFilter 过滤器说明： Actions representing HTTP Method values (GET
		 * -> read, POST -> create, etc) private static final String CREATE_ACTION =
		 * "create"; private static final String READ_ACTION = "read"; private static
		 * final String UPDATE_ACTION = "update"; private static final String
